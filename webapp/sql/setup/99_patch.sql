...
ALTER TABLE user_presents MODIFY id VARCHAR(15) NOT NULL;
ALTER TABLE user_presents MODIFY user_id VARCHAR(15) NOT NULL;
ALTER TABLE user_presents MODIFY item_id VARCHAR(15) NOT NULL;
